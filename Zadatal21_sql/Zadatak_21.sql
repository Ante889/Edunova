...
#0. Kreirajte tablice (16) i veze izme�u tablica. (6)
...
#3. U tablici svekrva obri�ite sve zapise �ija je vrijednost kolone jmbag
#00000000007. (4)

#4. Izlistajte nausnica iz tablice cura uz uvjet da vrijednost kolone
#bojakose sadr�e slova ana. (6)

#5. Prika�ite hlace iz tablice brat, ostavljen iz tablice svekrva te
#ekstroventno iz tablice ostavljen uz uvjet da su vrijednosti kolone
#bojakose iz tablice cura po�inju slovom a te da su vrijednosti kolone
#drugiputa iz tablice zena poznate. Podatke poslo�ite po ekstroventno
#iz tablice ostavljen silazno. (10)

#6. Prika�ite kolone drugiputa i asocijalno iz tablice zena �iji se
#primarni klju� ne nalaze u tablici zena_brat. (5)
