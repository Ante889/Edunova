...
<div class="grid-x align-spaced">
  <div class="cell large-4"><h5>Price</h5></div>
  <div class="cell large-2"><h4>15$</h4></div>
</div>
<hr>
<div class="grid-x align-spaced">
  <div class="cell large-4"><h5>Delivery</h5></div>
  <div class="cell large-2"><h4>0$</h4></div>
</div>
<hr>
<div class="grid-x align-spaced">
  <div class="cell large-4"><h5><b>Total Price</b></h5></div>
  <div class="cell large-2"><h4>0$</h4></div>
</div>
<hr>
<button type="button" class="success button button large">Finish</button>
</form>
